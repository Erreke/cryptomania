  ...
  <div class="wallets">
    <div v-for="(mentor, index) in loggedUser.mentors" class="wallet-row">
      ...
      <div class="wallet-col wallet-col-copy">
        <button type="button" class="btn btn-icon btn-icon-copy-wallet-number btn-sm"
                @click="handleCopyToClipboard(index)" title="Скопировать"></button>
        <button
          type="button"
          ...
          <span class="glyphicon glyphicon-qrcode"
                v-if="!QRCodeShowingProcessInfo.sendingStatus || QRCodeShowingProcessInfo.mentorId !== mentor.id"></span>
        </button>
