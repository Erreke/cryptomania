...
export function login(apiServerUrl, email, password) {
    return axios({
        method: 'post',
        url: apiServerUrl + '/api/signin',
...
export function register(apiServerUrl, firstName, phone, email, mentorId) {
    return axios({
        method: 'post',
        url: apiServerUrl + '/api/register',
        withCredentials: false,
        headers: {
            'Content-Type': 'application/json',
            'Accept': 'application/json'
...
export function check(apiServerUrl, token) {
    return axios({
        headers: {
            Authorization: `Bearer ${token}`
        },
        method: 'get',
        url: apiServerUrl + '/api/user?token=' + token
    })
}
